...
def _analytics_core_payload(row: Dict) -> Dict:
    return {
        ...
        "intensity_per_employee": row.get("intensity_per_employee"),
        "intensity_per_square_meter": row.get("intensity_per_square_meter"),
        "intensity_per_revenue": row.get("intensity_per_revenue"),
        "tags": row.get("tags"),
